...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'unitex_db');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'myphp-backup-files_'.date('d/m/Y')); // Comment this line to use same script's directory ('.')
...
echo "<h4>Database Backup Script</h4><hr>";
