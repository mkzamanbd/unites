...
if(isset($_POST['upload_btn']))
{
    ...
    $sgd = mysqli_query($con,"SELECT * FROM sg_currency ORDER BY id DESC LIMIT 1");
    $sgd_row = mysqli_fetch_array($sgd);
    $sgd_rate = $sgd_row['sg_rate'];
    $amount_sgd = $amount_bdt / $sgd_rate;
    $approved = "Not Yet Assigned";
    $porcessed = "Not Yet Assigned";
    ...
    $q = mysqli_query($con,"INSERT INTO expenditures(voucher_no,processed_by,inv_for ,purpose_of_exp,amount_bdt,amount_sgd,approved,porcessed,scan_doc,date,up_by) VALUES('$voucher_no','$processed_by','$inv_for ','$purpose_of_exp','$amount_bdt','$amount_sgd','$approved','$porcessed','$scan_doc','$date','$up_by')");
    if($q)
    {
