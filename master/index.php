...
if(isset($_POST['login_btn']))
    ...
    $check = mysqli_query($con,"SELECT * FROM master_user WHERE muser_name='$user_name' AND muser_password='$user_password'");
    
    $run_check = mysqli_num_rows($check);
    
    if($run_check==1)
    {   
        $_SESSION['muser_name']= $user_name;
        $_SESSION['muser_password']= $user_password;
